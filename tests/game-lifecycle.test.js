...
function harness() {
    ...
    const context = vm.createContext({
        ...session, ...powers, ...ai, aiValidMoves: ai.getValidMoves, LocalRoom,
        ...
        get: async () => ({ val: () => structuredClone(stats) }),
    ...
    globalThis.game = { STATE, startAIGame, startGame, resetRoom, sendMove, listenGameLoop };`;
    vm.runInContext(source, context);
    return { game: context.game, room, histories, pending, elements };
}
